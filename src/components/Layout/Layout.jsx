  ...
  return <div className="app-layout">
    ...
    {!hideHeader && <header className={`site-header${scrolled ? ' scrolled' : ''}`}><div className="header-container">
      ...
      <div className="nav-actions">
        ...
        <button className="hamburger-btn header-action-button" onClick={() => setMobileOpen((prev) => !prev)} aria-label={mobileOpen ? "Close menu" : "Menu"} aria-expanded={mobileOpen} type="button"><MenuGlyph isOpen={mobileOpen} /></button>
      </div>
    </div></header>}
    ...
    </div><div className="footer-bottom"><p className="footer-copyright">&copy; {new Date().getFullYear()} AliverBiopharm. All rights reserved.</p><nav className="footer-bottom-nav"><Link to="/privacy" className="footer-bottom-link">Privacy</Link><Link to="/terms" className="footer-bottom-link">Terms</Link><Link to="/about" className="footer-bottom-link">About</Link></nav></div></footer>}
  </div>;
}
